...
//esto es si se preciona el - y despues cualquier numero debe de borrarse el 0
  if(mathResult.value == '-0'){
    return mathResult.value = '-' + number;
  }
 ...
 //esta funcion hace que al precionar del elimine 1 numero de la calculadora
 deleteLastEntry(){
 ...
 calculateResult(){
  ...
  //eliminaremos los 2 ultimos caracteres que son el .0
